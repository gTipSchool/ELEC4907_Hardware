...
HD_PWD='H:/ELEC4907/Hardware/top_level_tests/top_level_tests.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sn_network_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sn_network_top_wrapper.tcl

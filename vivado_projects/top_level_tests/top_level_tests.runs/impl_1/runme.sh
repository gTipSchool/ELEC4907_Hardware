...
HD_PWD='H:/ELEC4907/Hardware/top_level_tests/top_level_tests.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sn_network_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sn_network_top_wrapper.tcl -notrace
